    ...
    const socialLinkIcons = {
        ...
        Reddit: (
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0s12 5.373 12 12zm-9.924-5.201l.001.001 3.54.71.747-3.499c.153-.713.974-1.084 1.686-.93.713.153 1.084.974.93 1.686l-.824 3.858c1.523.557 2.827 1.35 3.869 2.335.482.445.503 1.188.057 1.67-.445.482-1.188.503-1.67.057a8.417 8.417 0 00-7.635-2.257c-.29.069-.586.069-.876 0a8.423 8.423 0 00-7.635 2.257c-.482.446-1.225.425-1.67-.057a1.181 1.181 0 01.057-1.67 9.95 9.95 0 013.872-2.335l-.043-.203c-.743-3.464-.741-3.457-.741-3.459a1.273 1.273 0 011.015-.994c.698-.115.642-.103 4.671-.888 1.103-.221 2.03.706 1.903 1.8zm2.748 8.607c.544-.54 1.43.346.888.887-1.217 1.219-3.316 1.772-5.715 1.772-2.401 0-4.498-.553-5.716-1.772-.54-.54.346-1.426.888-.886 1.003 1.004 2.753 1.372 4.828 1.372 2.074 0 3.824-.368 4.827-1.372zM9.527 11.15a1.149 1.149 0 100 2.298 1.149 1.149 0 000-2.298zm4.947 0a1.149 1.149 0 100 2.298 1.149 1.149 0 000-2.298z" />
            </svg>
        )
    };
                ...
                >
                    <div className="w-72 rounded-xl border border-white/10 bg-[#1a1b26]/95 p-3 backdrop-blur-xl shadow-xl">
                        ...
                        <div className="mt-3 space-y-1">
                            ...
                            {SocialProfiles?.linkedin !== '' && <div className="group relative flex items-center justify-between rounded-xl p-2 transition-colors hover:bg-white/10">
                                <a
                                ...
                                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button
                                        onClick={() => copyToClipboard(SocialProfiles.linkedin)}
                            ...
                            {SocialProfiles?.github !== '' && <div className="group relative flex items-center justify-between rounded-xl p-2 transition-colors hover:bg-white/10">
                                <a
                                ...
                                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button
                                        onClick={() => copyToClipboard(SocialProfiles.github)}
                                        className="rounded-lg p-2 text-white/70 hover:bg-white/20 transition-colors"
                                        title="Copy URL"
                                    >
                                        <Copy className="h-4 w-4" />
                            ...
                            {SocialProfiles?.twitter !== '' && <div className="group relative flex items-center justify-between rounded-xl p-2 transition-colors hover:bg-white/10">
                                <a
                                ...
                                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button
                                        onClick={() => copyToClipboard(SocialProfiles.twitter)}
                                        className="rounded-lg p-2 text-white/70 hover:bg-white/20 transition-colors"
                                        title="Copy URL"
                                    >
                                        <Copy className="h-4 w-4" />
                            ...
                            {SocialProfiles?.instagram !== '' && <div className="group relative flex items-center justify-between rounded-xl p-2 transition-colors hover:bg-white/10">
                                <a
                                ...
                                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button
                                        onClick={() => copyToClipboard(SocialProfiles.instagram)}
                                        className="rounded-lg p-2 text-white/70 hover:bg-white/20 transition-colors"
                                        title="Copy URL"
                                    >
                                        <Copy className="h-4 w-4" />
                            ...
                            {SocialProfiles?.reddit !== '' && <div className="group relative flex items-center justify-between rounded-xl p-2 transition-colors hover:bg-white/10">
                                <a
                                ...
                                >
                                    ...
                                    <p className="text-base">Reddit</p>
                                </a>
                                <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button
                                        onClick={() => copyToClipboard(SocialProfiles.reddit)}
                                        className="rounded-lg p-2 text-white/70 hover:bg-white/20 transition-colors"
                                        title="Copy URL"
                                    >
                                        <Copy className="h-4 w-4" />
