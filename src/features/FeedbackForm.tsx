          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between mb-5">
                <h3 className="text-lg font-semibold tq-text-primary">
                  Share Your Feedback
                </h3>
                <motion.button
                      ...
                      >
                        <Star
                          className={`w-6 h-6 transition-colors duration-200 cursor-pointer ${
                            star <= rating
                              ? 'fill-[var(--tq-accent)] text-[var(--tq-accent)]'
                              : 'tq-text-muted hover:tq-text-muted'
                          }`}
                        />
                      </motion.button>
                    ))}
                ...
                <motion.button
                  ...
                  className={`w-full py-2 rounded-lg font-medium transition-all cursor-pointer ${
                    isSubmitting || rating === 0
                      ? 'tq-surface-1 tq-text-muted cursor-not-allowed'
                      : 'text-black shadow-lg shadow-[var(--tq-accent-glow)]'
                  }`}
                  style={{
