...
export const THEMES: ThemeMap = {
  ...
  midnight_default: {
    ...
    tokens: {
      ...
      '--tq-gradient-subtle':
        'linear-gradient(135deg, rgba(16,185,129,.05), rgba(59,130,246,.05))',
      '--tq-gradient-glass':
  ...
  aurora_borealis: {
    ...
    tokens: {
      ...
      '--tq-gradient-subtle':
        'linear-gradient(135deg, rgba(34,211,238,.05), rgba(129,140,248,.05))',
      '--tq-gradient-glass':
        'linear-gradient(135deg, rgba(34,211,238,0.1) 0%, transparent 50%, rgba(34,211,238,0.08) 100%)',
    },
  },
  ...
  cyber_neon: {
    ...
    tokens: {
      ...
      '--tq-gradient-subtle':
        'linear-gradient(135deg, rgba(217,70,239,.05), rgba(6,182,212,.05))',
      '--tq-gradient-glass':
        'linear-gradient(135deg, rgba(217,70,239,0.12) 0%, transparent 50%, rgba(217,70,239,0.1) 100%)',
    },
  },
  ...
  velvet_rose: {
    ...
    tokens: {
      ...
      '--tq-gradient-subtle':
        'linear-gradient(135deg, rgba(244,63,94,.05), rgba(245,158,11,.05))',
      '--tq-gradient-glass':
        'linear-gradient(135deg, rgba(244,63,94,0.12) 0%, transparent 50%, rgba(244,63,94,0.1) 100%)',
    },
  },
  ...
  arctic_frost: {
    ...
    tokens: {
      ...
      '--tq-gradient-subtle':
        'linear-gradient(135deg, rgba(34,211,238,.05), rgba(56,189,248,.05))',
      '--tq-gradient-glass':
        'linear-gradient(135deg, rgba(255,255,255,0.06) 0%, rgba(255,255,255,0) 50%, rgba(255,255,255,0.04) 100%)',
    },
  },
  ...
  ember_glow: {
    ...
    tokens: {
      ...
      '--tq-gradient-subtle':
        'linear-gradient(135deg, rgba(249,115,22,.05), rgba(234,179,8,.05))',
      '--tq-gradient-glass':
        'linear-gradient(135deg, rgba(249,115,22,0.12) 0%, transparent 50%, rgba(249,115,22,0.1) 100%)',
    },
  },
};
...
export const resolveThemeKey = (key: string): string => {
  if (THEMES[key]) return key;
  return LEGACY_ALIASES[key] || 'midnight_default';
};

export const getThemeTokens = (key: string): ThemeTokens => {
