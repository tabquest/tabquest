...
const todayFolder = { id: 'today', title: 'Today', isDefault: true, count: 0 };
const workFolder = { id: 'work', title: 'Work', count: 1, isDefault: false };
const mockTask = { id: 't1', title: 'Review PR', folder: 'work', done: false };
...
describe('taskSlice', () => {
  ...
  it('should handle updateTask', () => {
    ...
    const state = taskReducer(
      prevState,
      updateTask({ id: 't1', updates: { done: true } }),
    );
