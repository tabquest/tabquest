...
const getIconForField = (fieldName: string, type?: string) => {
  switch (fieldName) {
    case 'heading':
            ...
            <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="mb-4">
                  <div className="flex gap-3 mb-2">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setFormData({ ...formData, type: 'snippet' })
                      }
                      className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors duration-200 cursor-pointer
                    ...
                    <div className="relative">
                      <button
                        type="button"
                        onClick={() =>
                          setFormData({ ...formData, type: 'markdown' })
                        }
                        className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors duration-200 cursor-pointer
                ...
                <div className="relative">
                  ...
                  <p className="mt-1 text-xs tq-text-muted">
